...
const {createAttendance,getAllAttendance, getAttendanceByDate, updateAttendance, getAttendanceByName, AttendanceForNextWeek,getLastAttendance,WeekAttendance, getAttendanceBetweenDates}= require('../controllers/attendanceController');
...
router.route('/nextWeekAttendance/:selectedDate').get(AttendanceForNextWeek);
